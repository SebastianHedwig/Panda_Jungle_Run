...
export const GRAVITY_DOWN = 3500;
export const JUMP_FORCE = 1200;
export const APEX_BOOST = 0.6;
export const APEX_THRESHOLD = 120;

export const SOUND_MUTE_STORAGE_KEY = "SoundMute";
export const INITIAL_MUTE_STATE_GAMESTART = false;
...
export const LEVEL1_HEART_COUNT = 4;
export const LEVEL1_GUN_COUNT = 4;
export const LEVEL1_ENEMY1_COUNT = 5;
export const LEVEL1_ENEMY2_COUNT = 5;
export const LEVEL1_ENEMY3_COUNT = 3;
...
export const BOSS_SPAWN_CLEARANCE = 20;
export const BOSS_MOVE_MIN_X = 8300;
export const BOSS_MOVE_MAX_X = WORLD_WIDTH - 240;
export const BOSS_SPAWN_SHAKE_DURATION = 0.5;
export const BOSS_SPAWN_SHAKE_MAGNITUDE = 20;
